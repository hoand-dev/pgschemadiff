...
| [x] | P1-INFRA-06 | Type normalizer | backend-engineer | P0 | P1-INFRA-05 | M |
...
| [x] | P1-CLI-01 | `pgsd inspect <conn-url>` | backend-engineer | P1 | P1-INFRA-05 | M |
...
| [x] | P2-DOM-01b | Concrete delta subclasses — table/schema/extension deltas | backend-engineer | P0 | P2-DOM-01a | M |
