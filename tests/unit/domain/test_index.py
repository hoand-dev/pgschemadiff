...
def test_index_method_values() -> None:
    ...
    assert IndexMethod.HASH.value == "hash"
    assert IndexMethod.GIST.value == "gist"
    assert IndexMethod.GIN.value == "gin"
    assert IndexMethod.BRIN.value == "brin"
    assert IndexMethod.SPGIST.value == "spgist"
...
def test_nulls_order_values() -> None:
    assert NullsOrder.FIRST.value == "first"
    assert NullsOrder.LAST.value == "last"
