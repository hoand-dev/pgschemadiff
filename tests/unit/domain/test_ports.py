...
def test_schema_inspector_has_inspect_method() -> None:
    assert "inspect" in SchemaInspector.__protocol_attrs__  # type: ignore[attr-defined]
...
def test_migration_writer_has_write_method() -> None:
    assert "write" in MigrationWriter.__protocol_attrs__  # type: ignore[attr-defined]
